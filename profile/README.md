...
Pure independence is further acheived when early adopters are rewarded for their devotion to a new artist, organization, or technology and recieve ERC20 tokens that are redeemable for Ethereum, WFNB, and other mainstream tokens.  Today, this freedom is possible using Fanbase DeFi tools where you can earn rewards for getting on the bandwagon early. 
